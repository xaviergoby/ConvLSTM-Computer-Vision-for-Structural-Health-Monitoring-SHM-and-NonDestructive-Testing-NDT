...
class PredictionProducer:
    ...
    def __init__(self, img_rel_path, saved_trained_model_name):
        ...
        self.saved_trained_model_full_path = os.path.join(os.path.abspath("saved_trained_model_weights"),
                                                          "predictor.h5")
...
if __name__ == "__main__":
    ...
    print(os.path.join(os.path.abspath("saved_trained_model_weights"), "predictor.h5"))
    print(os.path.join(os.path.relpath(), "predictor.h5"))
