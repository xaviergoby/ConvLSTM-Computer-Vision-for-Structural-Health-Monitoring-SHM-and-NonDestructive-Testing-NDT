...
# history = model.fit(X_train, y_train, epochs=1, verbose=1, batch_size=1, validation_data=(X_val, y_val))
history = model.fit(X_train, y_train, epochs=1, verbose=1, batch_size=1, validation_split=0.05)
# history = model.fit(X_train, y_train, epochs=1, verbose=1, batch_size=1, validation_data=(X_val, y_val), callbacks=[tensorboard])
